...
**Sprint 7.10 claim:** Artifact 07 can evaluate local real-read gate request
objects and produce deterministic gate/evidence records. Fake/default mode is
allowed without credentials, unsafe real-read requests are blocked, and
