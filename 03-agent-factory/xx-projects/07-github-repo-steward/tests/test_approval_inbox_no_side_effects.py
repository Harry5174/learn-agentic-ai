...
def test_approval_inbox_does_not_require_common_secret_env_vars(monkeypatch) -> None:
...
def test_approval_inbox_does_not_open_network_sockets(monkeypatch) -> None:
    def fail_socket(*args: object, **kwargs: object) -> socket.socket:
        raise AssertionError("Approval inbox must not open network sockets.")
